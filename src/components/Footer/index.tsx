...
const Footer = () => (
  <footer className="w-full flex flex-col items-center justify-center p-2 text-center bg-gray-100 md:flex-row">
    ...
    <div className="flex flex-row items-center justify-center">
      <a aria-label="Linkedin" href="https://www.linkedin.com/in/pedrogon%C3%A7alvespereira/" target="_blank">
        <FaLinkedin fontSize={22} className="mx-2 hover:opacity-60" />
      </a>
      <a aria-label="Github" href="https://github.com/PGP27" target="_blank">
